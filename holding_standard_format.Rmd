...
holding_catch_data_dictionary <- tibble(variable_name = colnames(combined_holding), description = c("Date survey was conducted", "Reach number within watershed", "River mile number", "Number of fish observed", "Number of jacks observed", "Latitude measurement of adult holding", "Longitude measurement of adult holding", "Watershed name","Year survey was conducted", "Reason survey was conducted"), encoding = c("YYYY-MM-DD", NA,NA,NA,NA,NA,NA,NA, "YYYY", "august index, spawning" ), collected = c("All but Deer", "All","Battle and Clear", "All", "Battle and Clear", "Battle and Clear", "Battle and Clear", "All", "All","Clear"))
```
```{r, data_dictionary}
...
combined_holding %>% 
  ...
  ggplot(aes(x = watershed, y = river_mile)) + 
  geom_boxplot(
  )
```
