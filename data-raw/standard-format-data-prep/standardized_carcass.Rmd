...
-   Clear Creek
-   Feather River
-   Yuba River (not yet in markdown)
...
| river_mile | B, C | River mile where the survey was performed |
| date | B, Bu, F, C | Date the survey was performed |
...
|sex | B, Bu, F, C | Sex of the carcass |
|fork_length | B, Bu, F, C | Fork length of the carcass (mm) |
| adipose | B, Bu, F, C | Whether or not the adipose fin was clipped |
| carcass_condition | B, Bu, F, C | Condition of the carcass when sampled (i.e. fresh, decayed, non-fresh, bright, etc.) |
| spawn_condition | B, Bu, F, C | Spawning condition of the carcass sampled (i.e. spawned, unspawned, etc.) |
| run | B, F, C | Run of the carcass sampled, if assigned |
| stream | B, Bu, F, C | Stream from which the data was collected |
| chop_count | B, Bu, F, C | Count of chopped carcasses |
