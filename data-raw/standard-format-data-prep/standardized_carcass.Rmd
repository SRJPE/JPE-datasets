...
| individual_chops | Y | Yuba river-specific variable referring to chop count where biological information was taken |
| bulk_chops | Y | Yuba river-specific variable referring to dates where carcasses were bulk counted |
...
Not sure yet how to standardize Yuba's `individual_chops` and `bulk_chops` columns to match the `chop_count` and `tag_count` of other streams. 
