...
standard_catch <- read_csv("data/standard-format-data/standard_rst_catch.csv")
# length at date table from brett harvey
lad <- read_csv("data-raw/standard-format-data-prep/rivermodel_lengthrun_criteria.csv")
```
