...
boyds_landing_CDEC <- cdec_query(station = "FSB", dur_code = "H", 
                                 sensor_num = "20", start_date = "1996-01-01")
...
```{r}
boyds_landing_hourly_flows_clean <- boyds_landing_hourly_flows |> 
  mutate(flow_cfs = ifelse(flow_cfs < 0, NA_real_, flow_cfs))

boyds_landing_hourly_flows_clean_mean <- boyds_landing_hourly_flows_clean |> 
  group_by(date) |> 
...
saveRDS(boyds_landing_hourly_flows_clean_mean, 
