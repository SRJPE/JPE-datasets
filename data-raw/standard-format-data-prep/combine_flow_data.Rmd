...
# source USGS
battle <- read_rds("../../data-raw/standard-format-data-prep/flow_data/battle_flow.rds")
...
```{r}
# source CDEC
butte <- read_rds("../../data-raw/standard-format-data-prep/flow_data/butte_flow.rds")
...
```{r}
# source USGS
clear <- read_rds("../../data-raw/standard-format-data-prep/flow_data/clear_flow.rds")
...
```{r}
# source USGS
deer <- read_rds("../../data-raw/standard-format-data-prep/flow_data/deer_flow.rds")
...
feather_lfc_sites <- tibble(stream = c(rep("feather river", 3)),
                           site = c("gateway riffe", "eye riffle", "steep riffle"))
...
```{r}
# source USGS
mill <- read_rds("../../data-raw/standard-format-data-prep/flow_data/mill_flow.rds")
...
```{r}
# source USGS
yuba <- read_rds("../../data-raw/standard-format-data-prep/flow_data/yuba_flow.rds")
...
write_csv(combined_flow_clean, "../../data/standard-format-data/standard_flow.csv")
```