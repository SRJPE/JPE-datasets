...
# TODO convert depth to cm and m (currently in ft and in)
...
TODO river depth measured in m? No in ft - convert
...
check <- combined_trap %>%
  ...
  arrange(start_date) %>%
  mutate(date_ck = lag(end_date)) %>%
  filter(date_ck != start_date) %>%
  select(start_date, end_date, date_ck, location, site, subsite)
...
rst_trap_data_dictionary <- tibble(variable_name = colnames(combined_trap),
                                    description = c("Key variable that links trap operations to catch data and environmental data. Currently not all locations use this key.",
                                                    ...
                                                    "River depth from inside of the river left",
                                                    "River depth from directly in the center of cone",
                                                    "River depth from inside of the river right",
                                                    ...
                                                    "Date when trap was sampled/started.",
                                                    "Status of trap during visit",
                                                    "Time when trap was sampled/started.",
                                   ...
                                   collected = c("Battle, Clear",
                                                 ...
                                                 "Knights",
                                                 "Knights"),
                                    `not collected` = c("Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                       "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                       "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                       "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                       "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                       "Deer, Feather, Mill, Tisdale",
                                                       "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                       "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                      "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                       "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                      ...
                                                      "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                      "Butte, Deer, Feather, Mill, Tisdale",
                                                      "Butte, Yuba, Knights, Tisdale",
                                                      "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                      "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                      NA,
                                                      NA,
                                                      NA,
                                                      "Butte, Deer, Feather, Mill, Yuba, Knights, Tisdale",
                                                      "Battle, Clear, Knights, Tisdale",
                                                      "Battle, Clear, Deer, Mill, Knights, Tisdale",
                                                      "Battle, Clear, Deer, Mill, Knights, Tisdale",
                                                      "Battle, Clear, Deer, Feather, Mill, Knights, Tisdale",
                                                      "Battle, Clear, Deer, Feather, Mill, Knights, Tisdale",
                                                       "Battle, Butte, Clear, Deer, Mill, Yuba, Knights, Tisdale",
                                                      "Battle, Butte, Clear, Deer, Feather, Mill, Knights, Tisdale",
                                                      "Battle, Butte, Clear, Deer, Feather, Mill, Knights, Tisdale",
