...
rst_trap_data_dictionary <- tibble(variable_name = colnames(combined_trap),
                                    description = c("Key variable that links trap operations to catch data and environmental data. Currently not all locations use this key.", 
                                                    ...
                                                    "Volume of debris measured in trap (units = gallons).",
                                                    ...
                                                    "Revolutions on counter at start of sampling visit",
                                                    "Revolutions on counter at end of sampling visit"),
                                   ...
                                   collected = c("Battle, Clear, Knights, Tisdale", #1
                                                 ...
                                                 "Battle, Butte, Clear, Feather, Yuba, Knights",#5
                                                 "Battle, Butte, Clear, Yuba, Knights",#6
                                                 "Battle, Clear, Knights, Tisdale",#7
                                                 "Battle, Clear",#8
                                                 "Battle, Clear", #9
                                                 "Battle, Clear",#10
                                                 "Battle, Clear, Knights, Tisdale",#11
                                                 "Battle, Clear",#12
                                                 "Battle, Clear, Deer, Mill",#13
                                                 "Battle, Clear",#14
                                                 "Battle, Clear, Yuba, Knights",#15
                                                 "Battle, Clear, Deer, Feather, Mill, Knights, Tisdale",#16
                                                 "Battle, Clear",#17
                                                 "Battle, Clear",#18
                                                 NA, #19
                                                 "Battle, Clear",#20
                                                 "Butte, Feather, Yuba, Knights, Tisdale",#21
                                                 "Butte, Yuba",#22
                                                 "Butte, Yuba, Knights, Tisdale",#23
                                                 "Feather, Knights, Tisdale",#24
                                                 "Yuba, Knights, Tisdale",#25
                                                 "Yuba, Knights, Tisdale",#26
                                                 "Yuba",#27
                                                 "Yuba, Knights, Tisdale",#28
                                                 "Knights", #29
                                                 "Knights",
                                                 "Tisdale", 
                                                 "Tisdale")
