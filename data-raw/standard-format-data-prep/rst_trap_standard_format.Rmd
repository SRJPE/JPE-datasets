...
combined_trap <- combined_trap_raw %>%
  ...
  mutate(debris_level = case_when(debris_level == "veryheavy" ~ "very heavy", 
                                  is.na(debris_level) ~ "not recorded",
                                  T ~ debris_level),
         trap_functioning = case_when(trap_functioning %in% c("total block", "total blockage", "trap not in service") ~ "trap not in service",
                                         trap_functioning %in% c("not rotating", "cone stopped", "trap stopped functioning") ~ "trap stopped functioning",
