...
knights_effort <- read_csv(here::here("data", "rst", "knights_sampling_effort_clean.csv"))

# Knights landing data pulled from camp
# TODO add to cloud (this dataset was shared later and has not yet been added to cloud)
knights_landing_rst <- read_rds(here::here("data-raw", "qc-markdowns", "rst", "data-dictionaries",  "knights_landing_raw_catch.rds"))
```
