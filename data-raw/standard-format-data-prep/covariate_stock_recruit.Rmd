...
- In development: Emergence date (calculated from degree days and median spawning date)
...
- Includes the sum of the daily mean temperatures between August and December (spawning time period) by year and stream. Note that for streams with multiple locations the max daily mean was selected.
...
- Mean, meadian, max precipitation (or streamflow)
