...
redd_data_final <- all_redd_data |> 
  left_join(standard_reach_lookup, by = c("stream", "reach")) |> # TODO something weird going on with mill creek standardized reaches
  mutate(reach = ifelse(stream == "mill creek", reach, standardized_reach)) |> 
