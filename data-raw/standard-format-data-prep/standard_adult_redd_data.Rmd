...
UPDATE: Mill Creek was added to the daily data with a pseudo date as October 1. This is to allow Mill Creek data
to be added to the database without creating a seperate table.
...
redd_substrate_size_lookup <- 
  data.frame("redd_substrate_size" = unique(all_redd_data$redd_substrate_size),
             "standardized_size_range" = c(NA, "1-2", "2-4", "2-4", "2-4", "0.5-1", "2-4","2-4", '8-16', 
                                           "4-8", "1-2", "1-2", "4-8", "0.5-1", "1-2", "2-4", "0.5-1", "1-2", 
                                           "2-4", "2-4", "<0.25", "4-8", "4-8")) |> 
