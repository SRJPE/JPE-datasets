...
Due to the format of the data received, two redd datasets were developed. The first dataset includes Feather, Battle, and Clear Creek daily data and the second dataset includes Feather, Battle, Clear, and Mill Creek and is aggregated by year.
...
| reach                    | B, C, F            | Unique name identifer of reach sampled                             |
...
| stream                   | B, C, F            | Unique stream associated with redd data collected                  |
...
| year                     | B, C, F            | Calendar year sampling occurred                                    |
| velocity                 | B, C, F            | measured stream velocity (ft/s)                                    |

## Standard format for Adult Redd Data Aggregated by Year

Data dictionary for standard format for `redd_count_by_year`:
