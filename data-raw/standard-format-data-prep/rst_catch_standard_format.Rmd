...
# knights_rst <- read_csv(here::here("data", "rst", "knights_rst_clean.csv")) # contains cpue info
...
gcs_get_object(object_name = "rst/lower-sac-river/data-raw/knights-landing/knights_catch_camp.csv",
               bucket = gcs_get_global_bucket(),
               saveToDisk = here::here("data", "rst", "knights_catch.csv"),
               overwrite = TRUE)

knights_landing_rst <- read_csv(here::here("data/rst/knights_catch.csv"))
