...
# catch data
battle_rst <- read_csv(here::here("data", "rst", "battle_rst_catch.csv"), lazy = FALSE )
butte_rst <- read_csv(here::here("data", "rst", "butte_rst.csv"), lazy = FALSE ) # contains trap data too
butte_rst_camp <- read_csv(here::here("data", "rst", "butte_catch_camp.csv"), lazy = FALSE )
clear_rst <- read_csv(here::here("data", "rst", "clear_rst_catch.csv"), lazy = FALSE )
...
battle_environmental <- read_csv(here::here("data","rst", "battle_rst_environmental.csv"), lazy = FALSE )
battle_mark_recapture <- read_csv(here::here("data","rst", "battle_rst_mark_reacpture.csv"), lazy = FALSE )
butte_trap_camp <- read_csv(here::here("data", "rst", "butte_trap_camp.csv"), lazy = FALSE )
clear_environmental <- read_csv(here::here("data", "rst", "clear_rst_environmental.csv"), lazy = FALSE )
clear_mark_recapture <- read_csv(here::here("data", "rst", "clear_rst_mark_reacpture.csv"), lazy = FALSE )
...
combined_rst <- bind_rows(battle_rst_clean_final,
  ...
  mutate(run_lad_rivermodel = case_when((fork_length >= s_start_1 & fork_length < s_end_1) |
         ...
         is_yearling = case_when(fork_length <= cutoff ~ F,
                                 fork_length > cutoff ~ T,
                                 T ~ NA)) %>% # few cases primarily from pre 2002 Sac that are species are NA
  select(date, run, fork_length, lifestage, dead, interpolated, count, stream, site, subsite, adipose_clipped, run_method, species, release_id, weight, is_yearling)
