...
# # Set global bucket
# gcs_global_bucket(bucket = Sys.getenv("GCS_DEFAULT_BUCKET"))
>>>>>>> 4b5706e9c99d83664e5603b8bd46364f7c8de36f
...
write_csv(combined_release, "../../data/standard-format-data/standard_release.csv")

gcs_upload(combined_recapture,
           object_function = f,
           type = "csv",
           name = "standard-format-data/standard_recapture.csv")
write_csv(combined_recapture, "../../data/standard-format-data/standard_recapture.csv")
```