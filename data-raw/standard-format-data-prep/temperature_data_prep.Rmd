...
knitr::opts_chunk$set(echo = TRUE, warning = FALSE, root.dir = rprojroot::find_rstudio_root_file())
...
write_csv(IGO_CDEC,"IGO_CDEC.csv")
...
write_csv(DCV_CDEC,"DCV_CDEC.csv")
...
write_csv(DCV_USGS,"DCV_USGS.csv")
...
write_csv(GRL_CDEC,"GRL_CDEC.csv")
...
write_csv(MLM_CDEC,"MLM_CDEC.csv")
...
write_csv(MLM_USGS,"MLM_USGS.csv")
...
write_csv(WLK_CDEC,"WLK_CDEC.csv")
...
write_csv(WLK_USGS,"WLK_USGS.csv")
...
# from ashley - i am confused what is going on here - is this a station for clear lake?

# date must be last 10 years
# Elevation : 635.5 m 
# Link https://www.ncdc.noaa.gov/cdo-web/datasets/GHCND/stations/GHCND:USR0000CCOU/detail
NOAA_KEY <- 'IsRvscvYWFkXtEhLZAEIEyUlMXMCNIch'

tisdale_air_gage <- rnoaa::ncdc(datasetid = 'GSOM', stationid = 'GHCND:USC00R0000CCOU',
                         datatypeid = 'TAVG', startdate = '2000-01-01',
                         enddate = '2007-04-12', token = NOAA_KEY, limit = 130) %>% glimpse

tisdale_air_gage1 <- rnoaa::ncdc(datasetid = 'GSOM', stationid = 'GHCND:USR0000CCOU', 
                         datatypeid = 'TAVG', startdate = '2005-01-01', 
                         enddate = '2014-12-31', token = NOAA_KEY, limit = 130)
