...
# TODO: Plots to show gaps in sampling 
  # line plot followed with time frame
...
ggplot(WLK_hourly_temps, aes(x=date)) +
  geom_line(aes(y = temp_degf), color ="darkred") +
  labs(x="Year",y="Temperature (deg f)",title="Temperature at Sacramento River- Knights Landing", caption="CDEC")
```
...
ggplot(WLK_daily_temps, aes(x=date)) +
  geom_line(aes(y = temp_degf), color ="darkred") +
  labs(x="Year",y="Temperature (deg f)",title="Temperature at Sacramento River- Knights Landing",caption="USGS")
```
...
WLK_combined %>% 
  ...
  geom_line(aes(y = temp_CDEC), color ="darkred") +
  geom_line(aes(y = temp_USGS), color ="steelblue", linetype ="twodash") +
  labs(y="Temperature (deg f)",title="Temperature at Sacramento River- Knights Landing")
