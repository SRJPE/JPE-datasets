...
# TODO: Re-run Sac River, CDEC website was down
# TODO: Plots to show gaps in sampling
# TODO: Why is there difference in USGS vs CDEC?
...
ggplot(BCK_hourly_temps, aes(x=date)) +
  ...
  labs(x="Year",y="Temperature (deg f)",title="CDEC Water Temperature at Buttle Creek",caption="CDEC")
```
...
BCK_hourly_temps %>%
  filter(temp_degf<100, temp_degf>0) %>%
  ggplot(aes(x=date)) +
  geom_line(aes(y = temp_degf), color ="darkred") +
  labs(x="Year",y="Temperature (deg f)",title="CDEC Water Temperature at Buttle Creek", caption="CDEC")
```
...
ggplot(IGO_hourly_temps, aes(x=date)) +
  geom_line(aes(y = temp_degf), color ="darkred") +
  labs(x="Year",y="Temperature (deg f)",title="Water Temperature at Clear Creek",caption = "CDEC")
```
...
ggplot(DCV_hourly_temps, aes(x=date)) +
  geom_line(aes(y = temp_degf), color ="darkred") +
  labs(x="Year",y="Temperature (deg f)",title="Water Temperature at Deer Creek",caption="CDEC")
```
...
DCV_combined %>% 
  ...
  labs(y="Temperature (deg f)",title="Water Temperature at Deer Creek")
```
...
GRL_hourly_temps %>%
  ...
  ggplot(aes(x=date)) +
  geom_line(aes(y = temp_degf), color ="darkred") +
  labs(x="Year",y="Temperature (deg f)",title="CDEC Water Temperature at Feather River",caption="CDEC")
```
...
MLM_hourly_temps %>%
  ...
  ggplot(aes(x=date)) +
  geom_line(aes(y = temp_degf), color ="darkred") +
  labs(x="Year",y="Temperature (deg f)",title="CDEC Water Temperature at Mill Creek", caption = "CDEC")
```
...
WLK_hourly_temps %>%
  ...
  ggplot(aes(x=date)) +
  geom_line(aes(y = temp_degf), color ="darkred") +
  labs(x="Year",y="Temperature (deg f)",title="Temperature at Sacramento River - Tisdale",caption="CDEC")
```
...
ggplot(WLK_daily_temps, aes(x=date)) +
  geom_line(aes(y = temp_degf), color ="darkred") +
  labs(x="Year",y="Temperature (deg f)",title="Temperature at Sacramento River- Knights Landing: Daily)",caption="USGS")
```
...
TIS_CDEC <- cdec_query(station = "TIS", dur_code = "H", sensor_num = "25", start_date = "2010-01-01")
