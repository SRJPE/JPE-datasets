...
yuba_air_gage1 <- rnoaa::ncdc(datasetid = 'GSOM', stationid = 'GHCND:USR0000CFOR', 
                         datatypeid = 'TAVG', startdate = '2000-12-22', 
                         enddate = '2009-12-30', token = "IsRvscvYWFkXtEhLZAEIEyUlMXMCNIch", limit = 130)
 uba_air_gage1 <- yuba_air_gage1$data %>% 
  select(date,value) %>% 
  mutate(date = as.Date(date))

yuba_air_gage2 <- rnoaa::ncdc(datasetid = 'GSOM', stationid = 'GHCND:USR0000CFOR', 
                         datatypeid = 'TAVG', startdate = '2010-01-01', 
                         enddate = '2012-12-30', token = "IsRvscvYWFkXtEhLZAEIEyUlMXMCNIch", limit = 130)
