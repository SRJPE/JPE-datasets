...
## Observations: Upper Falls appears to have much lower temperatures compared to other logger sites and also CDEC data, we can assume that this due to the location of Upper Falls, higher up in the Feather river system where altitude is higher than closer to Sacramento confluence. Recommend to use this logger data since it is in area of adult fish spawning
```
