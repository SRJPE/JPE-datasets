...
holding_catch_data_dictionary <- tibble(variable_name = colnames(combined_holding), description = c("Date survey was conducted", "Reach number within stream", "River mile number", "Number of fish observed: Butte Creek data has multiple observations from different personnels per day - to prevent double counting, the average of each day at each reach is used as the daily fish count", "Number of jacks observed", "Latitude measurement of adult holding", "Longitude measurement of adult holding", "Stream name","Year survey was conducted", "Reason survey was conducted", " Location of the Picket Weir - this is unique to Clear Creek and it has the same value for the entire dataset","Fish above or below Picket Weir"), encoding = c("YYYY-MM-DD", NA,NA,NA,NA,NA,NA,NA, "YYYY", "august index, spawning", NA, "above, below" ), collected = c("All but Deer", "All","Battle and Clear", "All", "Battle and Clear", "Battle and Clear", "Battle and Clear", "All", "All","Clear", "Clear", "Clear"))
```
```{r, data_dictionary}
