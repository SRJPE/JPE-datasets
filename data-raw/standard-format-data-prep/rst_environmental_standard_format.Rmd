...
gcs_get_object(object_name = "rst/lower-sac-river/data/knights-landing/knl_combine_sampling_effort_clean.csv",
               bucket = gcs_get_global_bucket(),
               saveToDisk = here::here("data", "rst", "knights_landing_rst_environmental.csv"),
               overwrite = TRUE)

knights_landing_env <- read_csv(here::here("data", "rst", "knights_landing_rst_environmental.csv")) %>% 
...
unique(knights_landing_env$subsite)
...
combined_env <- bind_rows(battle_env, butte_env, clear_env, deer_env,
                          feather_env, knights_landing_env, tisdale_env, 
