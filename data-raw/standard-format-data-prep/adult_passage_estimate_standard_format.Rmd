...
# pull in mill creek VAKI estimates
# sent from Doug Killam doug.killam@wildlife.ca.gov
gcs_get_object(object_name = 
                 "adult-upstream-passage-monitoring/mill-creek/data-raw/MCVS 2021-22 spring FINAL 3-3-23.xlsx",
               bucket = gcs_get_global_bucket(),
               saveToDisk = here::here("data", "mill_escapement_estimates_21-22.xlsx"),
               overwrite = TRUE)
