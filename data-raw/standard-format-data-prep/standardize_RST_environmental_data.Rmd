...
```{r}
reordered_env <- combined_env %>% relocate(tributary, site, sub_site, date, sample_id, velocity, turbidity, 
                            temperature, flow, secchi, weather, lunar_phase, habitat, thalweg)
