...
```{r, include = F}
# source file where gage data is pulled
source(here::here("data-raw", "standard-format-data-prep", "temperature_data_prep.Rmd"))
# set up GCS
...
gcs_upload(combined_temp_clean,
           object_function = f,
           type = "csv",
           name = "standard-format-data/standard_temperature.csv.csv",
