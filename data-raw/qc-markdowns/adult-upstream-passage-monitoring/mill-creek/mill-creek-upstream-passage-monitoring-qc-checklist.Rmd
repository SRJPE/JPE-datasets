...
sheets <- readxl::excel_sheets("data-raw/qc-markdowns/adult-upstream-passage-monitoring/mill-creek/mill_creek_passage_estimate_raw.xlsx")
list_all <- lapply(sheets, function(x) readxl::read_excel(path = "data-raw/qc-markdowns/adult-upstream-passage-monitoring/mill-creek/mill_creek_passage_estimate_raw.xlsx", sheet = x, col_types = c("text", "numeric", "numeric", "numeric", "text")))
```
...
**Numeric Summary of passage_estimate From 2012 to 2023**
```{r}
