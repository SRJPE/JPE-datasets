...
```{r}
round(sum(is.na(feather_carcass_combined$count))/nrow(feather_carcass_chops_and_tags_combined), 3) * 100

```
* `r round(sum(is.na(feather_carcass_combined$count))/nrow(feather_carcass_chops_and_tags_combined), 3) * 100` % of values in the `count` column are NA.
...
**Plotting counts by disposition over period of record**
