...
# 
gcs_get_object(object_name = "adult-holding-redd-and-carcass-surveys/feather-river/data-raw/carcass/2010/ChopChannelTBL_2010.xlsx",
               bucket = gcs_get_global_bucket(),
               saveToDisk = "ChopChannelTBL_2010.xlsx",
               overwrite = TRUE)

gcs_get_object(object_name = "adult-holding-redd-and-carcass-surveys/feather-river/data-raw/carcass/2010/ChopHeaderTBL_2010.xlsx",
               bucket = gcs_get_global_bucket(),
               saveToDisk = "ChopHeaderTBL_2010.xlsx",
               overwrite = TRUE)

gcs_get_object(object_name = "adult-holding-redd-and-carcass-surveys/feather-river/data-raw/carcass/2010/ChopRecovTBL_2010.xlsx",
               bucket = gcs_get_global_bucket(),
               saveToDisk = "ChopRecovTBL_2010.xlsx",
               overwrite = TRUE)
gcs_get_object(object_name = "adult-holding-redd-and-carcass-surveys/feather-river/data-raw/carcass/2010/CWTHeaderTBL_2010.xlsx",
               bucket = gcs_get_global_bucket(),
               saveToDisk = "CWTHeader_2010.xlsx",
               overwrite = TRUE)

gcs_get_object(object_name = "adult-holding-redd-and-carcass-surveys/feather-river/data-raw/carcass/2010/CWTTagTBL_2010.xlsx",
               bucket = gcs_get_global_bucket(),
               saveToDisk = "CWTTag_2010.xlsx",
               overwrite = TRUE)
...
### ChopChannel_raw
ChopChannel_raw <- read_excel("ChopChannel_2010.xlsx") %>% 
  rename("ID" = HeaderID) %>%
  glimpse()
```
...
```{r}
ChopHeader_raw <- read_excel("ChopHeader_2010.xlsx") %>% 
  rename("ID" = headerID) %>%
  glimpse()
```
...
### ChopRecov_raw
```{r}
ChopRecov_raw <- read_excel("ChopRecov_2010.xlsx") %>% 
  glimpse()
```
### cwt_raw
```{r}
cwt_raw <- read_excel("CWTTag_2010.xlsx") %>% 
  glimpse
```
...
```{r}
cwt_header_raw <- read_excel("CWTHeader_2010.xlsx") %>% 
  glimpse
```
