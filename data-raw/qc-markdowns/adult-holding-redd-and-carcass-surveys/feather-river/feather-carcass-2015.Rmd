...
### Chop Variable: `header_id`, `min`, `sect`
...
```{r}
total_cwt_summary |> #TODO: kept this graph in; is it helpful?
...
chop_header_cleaner <- chop_header |>
  ...
  mutate(crew = str_replace_all(crew, " ", ","),
         ...
         weather = case_when(weather == "cld" ~ "cloudy",
                             weather %in% c("cld ran", "cld/rain", "cld,rain") ~ "cloudy, rain",
                             weather == "ran" ~ "rain",
...
```{r}
#Dropping sectiongroup, morale, tag and hallprint (tag and hallprint are NAs)
cwt_cleaner <- cwt |> 
  mutate_if(is.character, str_to_lower) |> 
  rename(tag_recapture_or_chop = recapture_or_chop) |> 
  mutate(crew = str_replace_all(crew, " ", ","),
         crew = str_replace_all(crew, ",,", ","),
         ...
         tag_recapture_or_chop = case_when(tag_recapture_or_chop == "t" ~ "tagged",
                                         tag_recapture_or_chop == "r" ~ "recaptured",
                                         tag_recapture_or_chop == "c" ~ "chopped",
         ...
         hallprint_color = case_when(hallprint_color == "g" ~ "G", 
