...
cwt_cleaner <- cwt %>% 
  mutate_if(is.character, str_to_lower) %>% 
  rename(tag_recapture_or_chop = recapture_or_chop) |> #TODO: is this necessary? standardizes across years
  mutate(crew = str_replace_all(crew, " ", ","),
         crew = str_replace_all(crew, ",,", ","),
         ...
         hallprint_color = case_when(hallprint_color == "g" ~ "G", # TODO: this was "grey" ~ "G" - syntax didn't make sense
