...
*  `r round(sum(is.na(cleaner_data_2009$date))/nrow(cleaner_data_2009), 3)*100` % of values in the `date` column are NA.
...
**Numeric Daily Summary of total redd_count Over 2009**
```{r}
cleaner_data_2009 %>%
  group_by(date) %>%
