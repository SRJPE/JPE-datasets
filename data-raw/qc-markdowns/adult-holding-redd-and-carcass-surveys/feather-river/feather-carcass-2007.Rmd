...
###Variable: `tag_count`, `tag_clip`, `tag_n_clip`, `tag_unk`
...
**Plot chop_recovery over Period of Record**

```{r}
ggplot(chop_recovery_join, aes(x = date, y = recov_count)) +
  geom_col() +
  theme_minimal() +
  scale_fill_manual(values = wes_palette("Moonrise2"))
```
...
```{r}
#Dropping male, female and gril columns - all empty
