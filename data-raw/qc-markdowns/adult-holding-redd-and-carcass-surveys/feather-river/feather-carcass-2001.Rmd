...
### Chop Recovery Variable: `tag_num`, `tag1`, `tag2`, `sect`, `fl`, `tag_env_id`, `tag_comp`, `flow`, `week_num`, `count`, `chop_env_id`, `minute`, `recov_id`, `recov_id`, `cwt_id`, `ht_num`, `recov_tag_id`
