...
```{r}
tag_join <- left_join(TagData_raw, RecovTag_raw) %>% # joining on Tag1, Tag2, TagComp because
  # these are the common column, though tag_num and recov_id could be related. Because we couldn't
  # tie them together decisively we are going with the common columns.
  clean_names() %>% 
