...
The `cwt` table contains information on individual carcasses. It is not joined with the other tables.
...
tags_with_dates <- left_join(all_tags, chop_recovery_join,
                             by = c("recov_id", "sect")) |> glimpse()
