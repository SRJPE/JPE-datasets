...
if(operating_system == "pc") {
  ...
  # ScaleSPLs is empty
  # TODO: check in on this with Ashley. What is Hallprint?
...
chop_recovery_join <- full_join(ChopHeader_raw %>% 
  ...
  clean_names()
# TODO: there are no matching IDs from the ChopRecov table that align with the ChopHeader ID column, so this produces NAs
```
