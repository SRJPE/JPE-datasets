...
colnames(cwt_raw) <- c("CWT.ID", "ID", "River.Section", "Tag.Recap.Chop.Color", "Tag.ID", "Recapture.or.Chop", "Sex",
...
```{r}
# TODO stopped collecting information about sex
# TODO CWT$HeaderID joins to CWT Header$HeaderID joins to Sampleweeks$Week Number joins to ChopHeader$week numberjoins to Chops$ChopHeaderID
