...
if(operating_system == "pc") {
  ...
  Carcass_individual_raw <- mdb.get(filepath, "CarcassIndividual")
...
write_csv(Chops_raw, here::here("data-raw", "qc-markdowns", "adult-holding-redd-and-carcass-surveys", "feather-river", "Chops_2017.csv"))
write_csv(ChopHeader_raw, here::here("data-raw", "qc-markdowns", "adult-holding-redd-and-carcass-surveys", "feather-river", "ChopHeader_2017.csv"))
write_csv(ChopRecov_raw, here::here("data-raw", "qc-markdowns", "adult-holding-redd-and-carcass-surveys", "feather-river", "ChopRecov_2017.csv"))
...
### Chops_raw
```{r}
Chop_raw <- read_csv(here::here("data-raw", "qc-markdowns", "adult-holding-redd-and-carcass-surveys", "feather-river","Chops_2017.csv")) |> 
  glimpse()
...
```{r}
ChopHeader_raw <- read_csv(here::here("data-raw", "qc-markdowns", "adult-holding-redd-and-carcass-surveys", "feather-river","ChopHeader_2017.csv")) |>
  mutate(Date = as.Date(SurveyDate)) |> 
  filter(year(Date) >= 2017) |> 
  glimpse()
# TODO stopped here 12-21-2022
```
