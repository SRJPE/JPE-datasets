...
non_na_dates <- cleaner_data_2013 |> filter(!is.na(date)) |> glimpse()

# FIX date that was incorrectly put into origional spreadsheet as 10/25/1013
na_dates <- cleaner_data_2013 |> 
  filter(is.na(date)) |> 
  mutate(date = as.Date("10/25/2013", format = "%m/%d/%Y"))

na_date_fix <- bind_rows(non_na_dates, na_dates)
#Convert to snakecase
cleaner_data_2013 <- na_date_fix %>% 
