...
# TODO: there is no matching ID in ChopRecov that will match up with ChopHeader ID, resulting in a ChopRecov table that is NAs
...
chop_channel_cleaner <- chop_channel_join %>%
  ...
  select(-c(time, male, fem, gril)) # male, female, and gril columns are empty
