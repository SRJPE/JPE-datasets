...
```{r}
ChopChannel_raw <- read_csv("ChopChannel_2004.csv") %>% 
  rename("ID" = HeaderID) %>% 
  glimpse()

ChopRecov_raw <- read_csv("ChopRecov_2004.csv") %>% glimpse

ChopHeader_raw <- read_csv("ChopHeader_2004.csv") %>% 
  rename("ID" = headerID) %>%
  glimpse()

cwt_raw <- read_csv("cwt_2004.csv") %>% glimpse()

cwt_header_raw <- read_csv("CWTHeader_2004.csv")
```
