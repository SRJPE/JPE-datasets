...
cwt <- left_join(cwt_raw |> clean_names(), 
  ...
  rename(hallprint1 = hallprint,
         sect = river_section) |> 
  select(-c(recapture_or_chop, morale, crew, section_group_1_10,
            section_group_11_15, section_group_16_21,
            section_group_22_38, cwt_id, header_id, tag, comments)) |> 
  glimpse()
```
