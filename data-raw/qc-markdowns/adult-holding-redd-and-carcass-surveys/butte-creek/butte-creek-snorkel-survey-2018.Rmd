---
title: "Butte Creek Snorkel Survey 2018 QC"
author: "Erin Cain"
date: "9/29/2021"
...
# Butte Creek Adult Snorkel Survey: 2018 Holding Data 
...
gcs_get_object(object_name = "adult-holding-redd-and-carcass-surveys/butte-creek/data-raw/Butte Snorkel 2018_MODIFIED.xls",
               bucket = gcs_get_global_bucket(),
               saveToDisk = "ButteSnorkel2018.xls",
               overwrite = TRUE)
```
...
```{r}
butte_snorkel <- readxl::read_excel("ButteSnorkel2018.xls") 
```
## Create function that transforms each sheet 

```{r}
file_names = c( "ButteSnorkel2018.xls", "ButteSnorkel2018.xls", "ButteSnorkel2018.xls")
sheet_names = c(1, 2, 3)
...
```{r}
butte_holding_2018 <- cleaner_data %>% glimpse
```

```{r, eval= FALSE}
f <- function(input, output) write_csv(input, file = output)
gcs_upload(butte_holding_2018,
           object_function = f,
           type = "csv",
           name = "adult-holding-redd-and-carcass-surveys/butte-creek/data/butte_holding_2018.csv")
```
