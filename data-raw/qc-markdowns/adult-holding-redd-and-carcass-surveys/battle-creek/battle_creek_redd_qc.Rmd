...
### 2020-2022
```{r}
# does not have matching age columns with 2021 and 2022
clean_2020_data <- raw_redd_2020 |> 
  janitor::clean_names() |> 
  glimpse()

# has add'l age data in age/date columns
...
# TODO bind and figure out age assignment
```
...
* `r round(sum(is.na(clean_redd_data_with_age$survey_method))/nrow(clean_redd_data_with_age), 3) * 100` % of values in the `survey_method` column are NA. 
...
* `r round(sum(is.na(clean_redd_data_with_age$reach_sub_unit))/nrow(clean_redd_data_with_age), 3) * 100` % of values in the `reach_sub_unit`column are NA. 
...
* `r round(sum(is.na(clean_redd_data_with_age$run))/nrow(clean_redd_data_with_age), 3) * 100` % of values in the `run`column are NA. 
...
* `r round(sum(is.na(clean_redd_data_with_age$redd_id))/nrow(clean_redd_data_with_age), 3) * 100` % of values in the `redd_id`column are NA. 
...
* `r round(sum(is.na(clean_redd_data_with_age$redd_loc))/nrow(clean_redd_data_with_age), 3) * 100` % of values in the `redd_loc`column are NA. 
...
* `r round(sum(is.na(clean_redd_data_with_age$survey))/nrow(clean_redd_data_with_age), 3) * 100` % of values in the `survey` column are NA. 
