...
#                saveToDisk = here::here("data-raw", "qc-markdowns","adult-holding-redd-and-carcass-surveys", "battle-creek", "raw_adult_spawn_hold_carcass.xlsx"))
               # Overwrite = TRUE)
...
cleaner_redd_data <- raw_redd_data |>  
  ...
  select(-c(project, year, date_measured, species_run)) |> # all are spring run
  glimpse()

# TODO pivot age columns to get more than one row for different ages

# TODO what is serial, corr_type, horz_prec, corr_date, fines_pres, 
# overhead_v, instream_c, cover_comm, stream_fea, tributary, trib_comm
```
