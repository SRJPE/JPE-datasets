...
Age Index refers to the number of times a unique redd has been surveyed. If `age_index == 1` it could either be no redd sampled or one redd sampled; any value for `age_index` over `2` indicates a unique redd has been sampled.			
...
Most redds are sampled 0 times or once.
