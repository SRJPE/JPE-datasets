...
```{r}
write_rds(hfc_feather, here::here("data-raw", "standard-format-data-prep","temp_data", "feather_hfc_temp.rds"))

write_rds(lfc_feather, here::here("data-raw", "standard-format-data-prep","temp_data", "feather_lfc_temp.rds"))
```
