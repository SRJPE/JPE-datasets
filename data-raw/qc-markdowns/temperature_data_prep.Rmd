...
TODO check if we are missing anything by checking USGS and CDEC data

Notes from Badhia: USGS data for Feather River across three stations
...
* CDEC only has one station, only data from time period stated above was found
...
TODO look into temp data in Yuba River USGS

-   daily max and min Temp data from 1964-2003, with some data gaps, for
    station number 11421000 Yuba R NR Marysville
