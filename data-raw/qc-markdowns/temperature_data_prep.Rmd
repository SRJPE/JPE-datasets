...
TODO We looked at USGS and only mean data is available starting 2016, CDEC has finer resolution hourly data, that is why we decided to use
CDEC. We are using USGS data to help filter out outliers.
