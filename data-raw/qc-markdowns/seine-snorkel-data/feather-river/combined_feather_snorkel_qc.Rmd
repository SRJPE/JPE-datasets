...
all_snorkel_data_section_names <- all_snorkel_data |> 
  mutate(section_name = case_when(section_name == "Eye" ~ "Eye Riffle",
                                 ...
                                 section_name %in% c("Vance West Riffle", "Vance East", "Vance West", "Vance W Riffle") ~ "Vance Riffle",
...
# TODO do we want to use the numbers from the map, and not these other survey numbers?
