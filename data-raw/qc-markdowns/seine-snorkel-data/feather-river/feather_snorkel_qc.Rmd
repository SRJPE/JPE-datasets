...
cleaner_snorkel_data <- raw_snorkel %>% 
  ...
  mutate(run = case_when(species  == "CHNF" ~ "fall",
        ...
        species = ifelse(species %in% c("CHN", "CHNT", "NONE", "CHNU", "CHNC", "CHNS", "CHNF"), "CHN", species)) %>%
...
There are `r length(unique(cleaner_snorkel_data$species))` unique species observed. 
