---
title: "Butte Creek CAMP Data Pull"
output: html_document
date: "2022-09-02"
---

This document queries the CAMP database provided by Grant Henely to extract
RST data for Butte Creek. 

If this file doesn't run, make sure operating system is being set correctly. 
Depending on the operating system this script will run either the query_butte_camp 
'4pc' or '4mac'
...
```{r}
gcs_get_object(object_name = "rst/CAMP/butte/CAMP_butte.mdb",
               bucket = gcs_get_global_bucket(),
               saveToDisk = here::here("data-raw", "qc-markdowns", "rst", "butte-creek", "CAMP.mdb"),
               overwrite = TRUE)
```
...
if(operating_system == "pc") {
  source(here::here("data-raw", "qc-markdowns", "rst", "butte-creek", "query_butte_camp_4pc.R"))
  } else{
    source(here::here("data-raw", "qc-markdowns", "rst", "butte-creek", "query_butte_camp_4mac.R"))
  }
```
...
gcs_upload(trap_visit_format,
           object_function = f,
           type = "csv",
           name = "rst/butte-creek/data-raw/butte_trap_camp.csv",
...
selected_catch <- catch_raw %>% 
  ...
  left_join(trap_visit_format %>% 
              select(projectDescriptionID, trapVisitID, visitTime, visitTime2, visitType, fishProcessed, siteName, subSiteName), by = c("trapVisitID" = "trapVisitID", "projectDescriptionID" = "projectDescriptionID")) %>% 
...
gcs_upload(selected_catch,
           object_function = f,
           type = "csv",
           name = "rst/butte-creek/data-raw/butte_catch_camp.csv",
           predefinedAcl = "bucketLevel")
```
...
gcs_upload(selected_recaptured,
           object_function = f,
           type = "csv",
           name = "rst/butte-creek/data-raw/butte_recaptures_camp.csv",
           predefinedAcl = "bucketLevel")
```
...
gcs_upload(selected_release,
           object_function = f,
           type = "csv",
           name = "rst/butte-creek/data-raw/butte_releases_camp.csv",
           predefinedAcl = "bucketLevel")
```
...
gcs_upload(selected_release_fish,
           object_function = f,
           type = "csv",
           name = "rst/butte-creek/data-raw/butte_release_fish_camp.csv",
           predefinedAcl = "bucketLevel")  
```
...
gcs_upload(environmental_format,
           object_function = f,
           type = "csv",
           name = "rst/butte-creek/data-raw/butte_environmental_camp.csv",
           predefinedAcl = "bucketLevel")
```
