---
title: "Clear Creek RST Passage Estimates QC"
author: "Erin Cain"
date: "11/10/2021"
...
* `r round(sum(is.na(cleaner_passage_estimate$location))/nrow(cleaner_passage_estimate), 3) * 100` % of values in the `location` column are NA. 
...
* Compare passage estimate method (Provided in R file) with other RST passage estimate methods
