---
title: "Knights Landing CAMP Data Pull"
output: html_document
date: "2022-09-02"
---

This document queries the CAMP database provided by Nick Bauer to extract
RST data for Knights Landing traps. 

Data was originally provided in excel spreadsheets from Jeanine Phillips. This script
updates the data originally provided.

If this file doesn't run, make sure operating system is being set correctly. 
Depending on the operating system this script will run either the query_knights_camp 
'4pc' or '4mac'
...
gcs_get_object(object_name = "rst/CAMP/knights_landing/CAMP_Knights.mdb",
               ...
               saveToDisk = here::here("data-raw", "qc-markdowns", "rst", "lower-sac", "knights_landing", "CAMP.mdb"),
               overwrite = TRUE)
```
...
if(operating_system == "pc") {
  source(here::here("data-raw", "qc-markdowns", "rst", "lower-sac", "knights_landing", "query_knights_camp_4pc.R"))
  } else{
    source(here::here("data-raw", "qc-markdowns", "rst", "lower-sac", "knights_landing", "query_knights_camp_4mac.R"))
  }
```
...
selected_trap_visit <- trap_visit %>%
  ...
  select(-trapPositionID, -siteID, -subSiteName)
...
gcs_upload(selected_recaptured,
           object_function = f,
           type = "csv",
           name = "rst/lower-sac-river/data-raw/knights-landing/knights_recaptures_camp.csv",
           predefinedAcl = "bucketLevel")
```
...
selected_release <- release %>% 
  ...
  # select for trap efficiency releases (note there are 8 records from 2014 that are experimental releases; 1 record that was live box retention, these are removed)
...
gcs_upload(selected_release,
           object_function = f,
           type = "csv",
           name = "rst/lower-sac-river/data-raw/knights-landing/knights_releases_camp.csv",
           predefinedAcl = "bucketLevel")
```
...
gcs_upload(environmental_format,
           object_function = f,
           type = "csv",
           name = "rst/lower-sac-river/data-raw/knights-landing/knights_environmental_camp.csv",
           predefinedAcl = "bucketLevel")
```
