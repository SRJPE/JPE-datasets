...
write_csv(josh_format_flow_daily, "data/datasets_for_josh/mean_daily_flow.csv")
```
...
gcs_get_object(object_name = paste0("jpe-model-data/weekly_releases_and_recaptures.csv"),
               ...
               saveToDisk = "data/datasets_for_josh/jpe_weekly_releases_and_recaptures.csv",
               overwrite = TRUE)

weekly_mark_recapture <- read_csv("data/datasets_for_josh/jpe_weekly_releases_and_recaptures.csv")
```
