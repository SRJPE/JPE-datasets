...
Are all the tags unique? No it looks like in more recent years they start to be unique and we have less NA values but there are 8 years where tags are not unique. 
```{r}
