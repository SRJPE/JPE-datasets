---
title: "deer-creek-upstream-monitoring-qc-checklist"
author: "Inigo Peng"
date: "10/19/2021"
...
Adult spring run salmon passage daily estimate is recorded at SVRIC Dam on Deer River via video monitoring.
...
**Numeric Daily Summary of passage_estimate From 2014 to 2020**
```{r}
cleaner_data %>%
  group_by(date) %>%
...
**Numeric Daily Summary of flow From 2014 to 2020**
```{r}
cleaner_data %>%
  group_by(date) %>%
...
**Numeric Daily Summary of temperature From 2014 to 2020**
```{r}
cleaner_data %>%
  group_by(date) %>%
