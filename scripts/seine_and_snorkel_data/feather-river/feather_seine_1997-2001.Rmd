...
Seine Id can be used to get additional information describing seine equipment. (Information on crew, depth, temp, ect...). We have this data in access database if we decide we want it. 
