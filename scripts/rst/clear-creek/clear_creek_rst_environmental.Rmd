...
A lot of outliers are shown. These are clear because they create a large spike and make the other velocity measurements difficult to see. 
...
A velocity of 280 seems out of the range of possibilities. It seems like every velocity greater than 7 is probably a mistake that should be scaled down or filtered out. 
