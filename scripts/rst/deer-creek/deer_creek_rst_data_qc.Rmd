...
Code describing trap condition. TODO figure out code definitions (Waiting on reply from Matt)
```{r}
...
Code describing weather condition. TODO figure out code definitions (Waiting on reply from Matt)
```{r}
