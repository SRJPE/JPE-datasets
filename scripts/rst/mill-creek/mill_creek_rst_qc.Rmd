...
RST data was shared with us in an access database. I quiried it to include both fish catch and trap condions information. 
...
tubs_of_debris of the fish captured					
