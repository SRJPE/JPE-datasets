...
TODO: Ask for clarification/description for brood_year(is this a description for the carcasses?) 
...
* Some columns such as 'run' and 'run_call' seem to overlap - need to email Ryan 
