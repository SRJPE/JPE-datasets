...
* `r round(sum(is.na(cleaner_data_2012$'date'))/nrow(cleaner_data_2012), 3)*100` % of values in the `date` column are NA.
...
**Numeric Daily Summary of salmon_count Over 2012**
```{r}
cleaner_data_2012 %>%
  group_by(date) %>%
...
**Numeric summary of salmon_count by location in 2012**
```{r}
cleaner_data_2012 %>%
  group_by(location) %>% 
  summarise(count = sum(salmon_count, na.rm = T)) %>% 
...
* `r round(sum(is.na(cleaner_data_2012$salmon_count))/nrow(cleaner_data_2012), 5)*100` % of values in the `salmon_count` column are NA. 
...
**Numeric Daily Summary of redd_count Over 2012**
```{r}
cleaner_data_2012 %>%
  group_by(date) %>%
...
* `r round(sum(is.na(cleaner_data_2012$redd_count))/nrow(cleaner_data_2012), 5)*100` % of values in the `redd_count` column are NA.
...
* `r round(sum(is.na(cleaner_data_2012$'longitude'))/nrow(cleaner_data_2012), 3)*100` % of values in the `longitude` column are NA.  

* `r round(sum(is.na(cleaner_data_2012$'latitude'))/nrow(cleaner_data_2012), 3)*100` % of values in the `latitude` column are NA.
...
* `r round(sum(is.na(cleaner_data_2012$'percent_boulder'))/nrow(cleaner_data_2012), 3)*100` % of values in the `percent_boulder` column are NA.
...
**Numeric Summary of velocity_m_per_s Over 2012**
```{r}
...
* `r round(sum(is.na(cleaner_data_2012$'velocity_m_per_s'))/nrow(cleaner_data_2012), 3)*100` % of values in the `velocity_m_per_s` column are NA.
