...
* `r round(sum(is.na(cleaner_carcass_data$location))/nrow(cleaner_carcass_data), 3) * 100` % of values in the `method` column are NA.
...
* `r round(sum(cleaner_carcass_data$carcass_live_status == "unknown")/nrow(cleaner_carcass_data), 3) * 100` % of values in the `carcass_live_status` column are `Unknown`.
...
* `r round(sum(cleaner_carcass_data$spawn_condition == "unknown")/nrow(cleaner_carcass_data), 3) * 100` % of values in the `spawn_condition` column are `Unknown`.
...
* `r round(sum(cleaner_carcass_data$run == "unknown")/nrow(cleaner_carcass_data), 3) * 100` % of values in the `run`` column are `Unknown`.
