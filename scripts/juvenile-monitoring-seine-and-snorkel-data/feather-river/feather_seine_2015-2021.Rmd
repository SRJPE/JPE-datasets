...
* `r round(sum(is.na(cleaner_seine_data$longitude))/nrow(cleaner_seine_data), 3) * 100` % of values in the `longitude` column # Check that they are in consistent format
# Mapare NA. 
