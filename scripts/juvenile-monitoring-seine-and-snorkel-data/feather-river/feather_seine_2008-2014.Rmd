...
```{r}
library(sp)
utm_coords <- na.omit(subset(cleaner_seine_data, select = c("x_coord", "y_coord")))
utm_coords <- sp::SpatialPoints(utm_coords,proj4string=CRS("+proj=utm +zone=10 +datum=WGS84"))
...
* TODO need to figure out what is going on with the substrate and cover columns. (waiting to hear back from Casey)
