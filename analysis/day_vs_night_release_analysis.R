...
# Create function to view differences in day vs night releases 
plot_day_or_night <- function(watershed, sites) {
  ...
  # Create tibble displaying stats
...
# Redo excluding dawn/dusk 

plot_day_or_night_excluding_dawn_dusk <- function(watershed, sites) {
  night_releases <- release_raw %>% 
    mutate(release_date = as_date(release_date), 
...
plot_day_or_night_excluding_dawn_dusk("battle creek", sites = "ubc")
plot_day_or_night_excluding_dawn_dusk("clear creek", "lcc")
plot_day_or_night_excluding_dawn_dusk("clear creek", "ucc")
plot_day_or_night_excluding_dawn_dusk("feather river", "gateway riffle")
plot_day_or_night_excluding_dawn_dusk("feather river", "herringer riffle")

plot_day_or_night_excluding_dawn_dusk("feather river", "eye riffle")
plot_day_or_night_excluding_dawn_dusk("feather river", "live oak")
plot_day_or_night_excluding_dawn_dusk("feather river", "herringer riffle")
plot_day_or_night_excluding_dawn_dusk("feather river", "steep riffle")
plot_day_or_night_excluding_dawn_dusk("feather river", "sunset pumps")
plot_day_or_night_excluding_dawn_dusk("feather river", "gateway riffle")