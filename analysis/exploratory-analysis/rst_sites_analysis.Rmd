...
salmonid_extents <- readOGR(here::here("analysis", "exploratory-analysis", 
                                       "data-raw", "salmonid_habitat_extents", "salmonid_habitat_extents.shp"), 
...
```{r}
rst_catch <- read_csv(here::here("data", "standard-format-data", "standard_rst_catch.csv"))
