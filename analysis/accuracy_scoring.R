...
# COMMENTED OUT, HOPING WE CAN USE DIRECT PULL FROM GOOGLE DOC------------------
...
#### Working for me but left above code in case it isn't for you! 
scores <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/1i9-ItUZL8e_UG75Y54U9RGHYge93dXGoYvIYY_BTDN8/edit?usp=sharing", 
                                    sheet = 7, 
                                    col_types = "cccllllccc") |> 
  janitor::clean_names() |> glimpse()

lookup <- googlesheets4::read_sheet("https://docs.google.com/spreadsheets/d/1i9-ItUZL8e_UG75Y54U9RGHYge93dXGoYvIYY_BTDN8/edit?usp=sharing", 
                                    sheet = 8,
                                    col_types = "cccll") |> 
  janitor::clean_names() |> glimpse()
...
summarized_scores <- lookup |> 
  ...
  pivot_longer(cols = single_annual_number:delta_entry_timing, 
