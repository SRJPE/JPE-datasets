...
It looks like the average fork length and weight will fall within these axis ranges as these bound are more representative of the data than we had originally because there does not appear to be any extreme outliers. Now, we can get our expected ranges by getting the five number summary for the following.
